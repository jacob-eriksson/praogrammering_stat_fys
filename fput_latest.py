...
plt.plot(time,100*np.array(E1),label="E1")
plt.plot(time,100*np.array(E2),label="E2")
plt.plot(time,100*np.array(E3),label="E3")
plt.plot(time,100*np.array(E4),label="E4")

plt.xlabel("i dt ω1 / 2π")
plt.ylabel("100 E_k")
plt.legend()
plt.show()
